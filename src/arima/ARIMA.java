...
public class ARIMA {
    ...
    private double stderrDara = 0;
    private double avgsumData = 0;
    private Vector<double[]> armaARMAcoe = new Vector<double[]>();
    private Vector<double[]> bestarmaARMAcoe = new Vector<double[]>();
